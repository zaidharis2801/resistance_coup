...
class PlayMomAgent:
    ...
    def __init__(self) -> None:
        ...
        self.Mom = PlayerBase(
            ...
            name="Mom",
            coins=2,
            prompt_str="Mom is a charismatic and charming player, who enjoys the art of persuasion. His bluffs are incredibly convincing, making it difficult for others to discern his true intentions. He thrives on the challenge of outwitting his opponents through deception and psychological tactics.",
            details="Mom has an extensive understanding of game dynamics and psychology, frequently studying bluffing techniques and tactics, making him a master of misinformation. His preferred cards are Duke and Assassin, and his favorite actions are claiming to be Duke or Assassin, challenging other players' claims, and taking risky actions based on bluffs.",
    ...
    """
        ...
        if chosen_play in plays2:
            attack_on = random.randint(0, len(rational_knowledge["players_except_self"])-1)
            attack_on_name = rational_knowledge["players_except_self"]["Player" + str(attack_on)]["name"]
    ...
    def play_final_answer(state: list):
        ...
        """
        final_answer_llm = ChatOpenAI(temperature=0).bind_tools([PlayMomAgent.final_answer_tool_play], tool_choice="final_answer_play")
